...
partial, unassigned; final, no successor. Local synthetic example complete.
...
153/153 tests/typecheck/build pass; original 71 source hashes preserved.
...
current `flight-continuation-20260914/`.
[Evidence](t09.md#continuation-2026-09-14-synthetic-flight-continuation).
...
1. Recheck workspace, T09/index and example gaps; expand only for a relevant question.
